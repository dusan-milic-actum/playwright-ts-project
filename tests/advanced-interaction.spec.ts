...
test.skip('Advanced Interaction', async ({ page }) => {
    await page.goto('file:///D:/repos/playwright-ts-project/tests/resources/index.html');
...
test.skip('Handling iframe', async ({ page }) => {
    await page.goto('file:///D:/repos/playwright-ts-project/tests/resources/iframe.html');
